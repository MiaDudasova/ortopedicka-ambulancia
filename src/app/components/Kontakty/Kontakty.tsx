  ...
  return (
    <div className={styles.kontakty}>
      <div className={styles.imageWrapper}>
        <img
          src="/images/ortoticke-centrum-mapa.png"
          alt="Mapa"
          className={styles.image}
        />
        <a
          href="https://www.google.com/maps/place/ORTOTICK%C3%89+CENTRUM+s.r.o/@48.0239872,17.319626,17z/data=!4m6!3m5!1s0x476c7fb712aac6b1:0x722a3e82de6da923!8m2!3d48.0232338!4d17.3221151!16s%2Fg%2F11f5grpdmg?entry=ttu"
          target="_blank"
        ...
        <div className={styles.kontaktOrdinacne}>
          <div className={styles.kontakt}>
            ...
            <div className={styles.kontaktneInfo}>
              ...
              <div className={styles.info} style={{fontWeight: "bold"}}>
                0908 446 496 <br />{" "}
